...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
      <a class="navbar-brand" href="#">Notification in PHP</a>
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        ...
        <form method="post" class="form-inline my-2 my-lg-0">
          <input name="message" class="form-control mr-sm-2" type="text" placeholder="Your Comments Here" required>
          <button name="submit" class="btn btn-outline-success my-2 my-sm-0" type="submit">Comments Button</button>
        </form> |
          <?php
          ...
          ?>
        <form method="post" class="form-inline my-2 my-lg-0">
          <input name="name" class="form-control mr-sm-2" type="text" placeholder="Your Name Here" required>
          <button name="like" class="btn btn-outline-success my-2 my-sm-0" type="submit">Like Button</button>
        </form>
      </div>
    </nav>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template" style="margin-top: 100px">
        <h1>Simple notification / reminder</h1>
        <p class="lead">This part done by Meem </p>
      </div>
